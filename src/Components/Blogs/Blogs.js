...
const Blogs = () => {
    return (
        <div className='blogs-container'>
            ...
            <p><span className='span'>Ans:</span><br /> The Context API is a React structure that enables you to exchange unique details and assists in solving prop-drilling from all levels of your application.<br /> Context provides a way to share values like these between components without having to explicitly pass a prop drilling  through.</p>
            <h3>Q 2. What is semantic tag ?</h3>
            <p><span className='span'>Ans:</span><br /> Semantic HTML elements are those that clearly describe their meaning in a human- and machine-readable way. All elements considered semantic because<br /> they accurately describe the purpose of the element and the type of content that is inside them.</p>
